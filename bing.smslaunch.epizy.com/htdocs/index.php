...
<html lang="en" dir="ltr">
    <head>
        ...
        <link rel="preload" href="MariaM_blog-1024x576.png" type="image">
       ...
       <!-- MIGRATE TO PHP ->>><script>
            ...
            if (url.searchParams.get('q') || url.searchParams.get("s")) {
                ...
                redir.href = "https://www.bing.com/search?q="+ url.searchParams.get('q');
                redir.click();
            }
        </script>-->
    </head>
    <body data-priority="2">
        <div class="hpapp">
            <div class="hp_body  ">
                <div class="hpl">
                    <div class="img_cont" id="bg_img" style="background-image: url(MariaM_blog-1024x576.png); opacity: 1;">
                ...
                <div class="hpl hp_cont">
                    <header class="header" id="hdr">
                        <div class="head_cont">
                            <h1 class="logo_cont" aria-labelledby="bLogo" style="color: #808080; vertical-align: bottom;">
                                ...
                                <!--&ensp;and&ensp;
                                <svg id="bLogo" class="logo" viewBox="0 0 154 28" aria-label="Bing">
                                    <svg class="squares">
                            ...
                            <div class="scope_cont">
                                <ul style="margin-top: .7vh;">
                                    <li class="scope" style="color: rgba(255,255,255,.8); display: inline; margin-right: 36px;">
                                        <a href="http://google.smslaunch.epizy.com" style="color: inherit; font-size: small;">Google</a>
                                    </li>
                                    <li class="scope try_exp" style="color: rgba(255,255,255,.8); display: inline; margin-right: 36px;">
                                        <a href="http://ddg.smslaunch.epizy.com" style="color: inherit; font-size: small;">DuckDuckGo</a>
                                    </li>
                    ...
                    <div class="sbox ">
                        <form data-h="ID=HpApp,21474.1" class="sb_form hassbi hasmic" id="sb_form" action="//www.bing.com/search">
